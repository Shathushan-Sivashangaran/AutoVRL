...
from Env.resources.Road_50 import road_50

from Env.resources.Building_1_1 import building_1_1
from Env.resources.Building_2_1 import building_2_1
from Env.resources.Building_3_1 import building_3_1
from Env.resources.Building_1_2 import building_1_2
from Env.resources.Building_2_2 import building_2_2
from Env.resources.Building_3_2 import building_3_2
from Env.resources.Building_4_2 import building_4_2
from Env.resources.Building_1_3 import building_1_3
from Env.resources.Building_2_3 import building_2_3
from Env.resources.Building_3_3 import building_3_3

from Env.resources.Vehicle_2_1 import vehicle_2_1
from Env.resources.Vehicle_5_1 import vehicle_5_1
from Env.resources.Vehicle_2_2 import vehicle_2_2
from Env.resources.Vehicle_3_2 import vehicle_3_2
from Env.resources.Vehicle_4_2 import vehicle_4_2
from Env.resources.Vehicle_6_2 import vehicle_6_2

class X10Car_Env_urb50(gym.Env):
    ...
    def __init__(self):
        ...
        self.building_1_1=None; self.building_2_1=None; self.building_3_1=None
        self.building_1_2=None; self.building_2_2=None; self.building_3_2=None; self.building_4_2=None
        self.building_1_3=None; self.building_2_3=None; self.building_3_3=None

        self.vehicle_1_1=None; self.vehicle_2_1=None; self.vehicle_3_1=None; self.vehicle_4_1=None; self.vehicle_5_1=None
        self.vehicle_1_2=None; self.vehicle_2_2=None; self.vehicle_3_2=None; self.vehicle_4_2=None; self.vehicle_5_2=None; self.vehicle_6_2=None
    ...
    def step(self, action):
        ...
        if(self.store_agent_steps == 10000000):
            self.writeReward.to_csv('reward_urb50.csv', index = False)
            self.store_agent_steps = 0
        ...
        if (min_dist_to_wall < 0.6):
            ...
            self.writeEpisodeReward.to_csv('episode_reward_urb50.csv', index = False)
            self.episode_reward = 0
        ...
        if (self.store_agent_steps <= 5000):
            ...
            if (self.store_agent_steps == 5000):
                self.trajectory.to_csv('trajectory_urb50.csv', index = False)
    ...
    def reset(self):
        ...
        self.plane = road_50(self.client)
        self.car = x10car_v0(self.client)
        self.wall = walls_50(self.client)

        self.building_1_1=building_1_1(self.client); self.building_2_1=building_2_1(self.client); self.building_3_1=building_3_1(self.client)
        self.building_1_2=building_1_2(self.client); self.building_2_2=building_2_2(self.client); self.building_3_2=building_3_2(self.client)
        self.building_4_2=building_4_2(self.client); self.building_1_3=building_1_3(self.client); self.building_2_3=building_2_3(self.client); self.building_3_3=building_3_3(self.client)

        self.vehicle_2_1=vehicle_2_1(self.client); self.vehicle_5_1=vehicle_5_1(self.client); self.vehicle_2_2=vehicle_2_2(self.client); self.vehicle_3_2=vehicle_3_2(self.client)
        self.vehicle_4_2=vehicle_4_2(self.client); self.vehicle_6_2=vehicle_6_2(self.client)
    ...
    def render(self, mode='human'):
        ...
        view_matrix = p.computeViewMatrix([pos[0],pos[1],15], pos + camera_vec, up_vec)
